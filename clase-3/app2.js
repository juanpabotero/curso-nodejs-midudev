// esta es la version de la app usando la forma nativa de habilitar cors
...
app.get('/movies', (req, res) => {
  // el navegador no envia la cabecera origin si la petición es del mismo origin
  // req.header() obtiene el valor de una cabecera
  const origin = req.header('origin');

  if (ACCEPTED_ORIGINS.includes(origin) || !origin) {
    // para permitir que origenes pueden acceder a este recurso
...
// para permitir que el navegador haga una peticion OPTIONS
// y saber que metodos y cabeceras puede enviar
app.options('/movies/:id', (req, res) => {
  ...
  if (ACCEPTED_ORIGINS.includes(origin) || !origin) {
    // para permitir que origenes pueden acceder a este recurso
    res.header('Access-Control-Allow-Origin', origin);
    // para permitir que metodos pueden acceder a este recurso
